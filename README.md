...
const float = defineNodeDefinition({
  id: "core.float",
  version: "0.1.0",
  displayName: "Float",
  category: "Core",
...
validate through `@skenion/contracts` on the supported Contracts `0.51` line.
...
`>=0.51.0 <0.52.0`. SDK package versions may differ from Contracts package
