...
and paste payloads use the exact `@skenion/contracts` package version declared
by this SDK.
...
`validateCompatibilityMatrixV01` export, then adds SDK-specific exact-version and
